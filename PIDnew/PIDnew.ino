...
/*void calibration() {
  ...
  delay(200);
  SerialUSB.println("Front QTR Sensor Calibration:");
  ...
  SerialUSB.println();
  SerialUSB.println("Back QTR Sensor Calibration:");
  for (uint8_t j = 0; j < BackSensorCount; j++) {
    SerialUSB.print("Back Sensor ");
    SerialUSB.print(j);
    SerialUSB.print("   min = ");
    SerialUSB.print(qtrBack.calibrationOn.minimum[j]);
    SerialUSB.print("    max = ");
    SerialUSB.println(qtrBack.calibrationOn.maximum[j]);
  }
  SerialUSB.println();
  delay(2000);
  }*/
void calibration_loop(int loop_times)
{
...
void calibration() {
  SerialUSB.println("Calibrating1");
  for (uint16_t i = 0; i < 40; i++) {
    motoron1.setSpeed(1, 100);
    motoron1.setSpeed(2, -100);
    qtr.calibrate();
    delay(1);
  }
  motoron1.setSpeed(1, 0);
  ...
  SerialUSB.println("Calibrating2");
  for (uint16_t i = 0; i < 40; i++) {
    motoron1.setSpeed(1, -300);
    motoron1.setSpeed(2, 300);
    qtr.calibrate();
    delay(1);
  }
  motoron1.setSpeed(1, 0);
  ...
  delay(300);
  SerialUSB.println("Calibrating4");
  for (uint16_t i = 0; i < 40; i++) {
    motoron1.setSpeed(1, -300);
    motoron1.setSpeed(2, 300);
    qtr.calibrate();
  ...
  delay(300);
  SerialUSB.println("Calibrating5");
  for (uint16_t i = 0; i < 40; i++) {
    motoron1.setSpeed(1, 200);
    motoron1.setSpeed(2, -200);
    qtr.calibrate();
  ...
  delay(300);
  SerialUSB.println("Calibrating6");
  for (uint16_t i = 0; i < 40; i++) {
    motoron1.setSpeed(1, -100);
    motoron1.setSpeed(2, 300);
    qtr.calibrate();
